...
const GlobalStyle = createGlobalStyle`
  ...
  body.dark-layout .navbar .nav-link {
    color: #d0d2d6;
  }
...
const ThemeToggle = () => {
  ...
  useEffect(() => {
    ...
    if (savedTheme) {
      ...
      document.body.classList.toggle("dark-layout", savedTheme === "dark");
    }
  }, []);
  ...
  const toggleTheme = () => {
    ...
    document.body.classList.toggle("dark-layout", newTheme === "dark");
  };
    ...
    <>
      ...
      <li className="nav-item d-none d-lg-block">
        <NavLinkStyled
          ...
          onClick={toggleTheme}
        >
          {darkMode ? <FiSun style={{ fontSize: "22px" }} /> : <FiMoon  style={{ fontSize: "22px" }}/>}
        </NavLinkStyled>
      </li>
    </>
  );
