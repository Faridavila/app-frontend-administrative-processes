...
const InventoryHistory: React.FC<InventoryHistoryCRUDProps> = ({
  onRowClick,
}) => {
  const [selectedhistoryInventory, setSelectedHistoryInventory] =
    useState<InventoryHistoryTypes | null>(null);
  ...
  const handleDownloadPDF = () => {
    ...
    const pdfConfig: PDFConfig = {
      ...
      mainInfo: [
        ...
        {
          label: "Tipo de Transacción",
          value: selectedhistoryInventory.transactionType || "N/A",
        },
        {
          label: "Tipo de Usuario",
          value: selectedhistoryInventory.typeUser || "N/A",
        },
        { label: "Usuario", value: selectedhistoryInventory.userName || "N/A" },
        {
          label: "Fecha de Movimiento",
          value: selectedhistoryInventory.date || "N/A",
        },
        {
          label: "Observación",
          value: selectedhistoryInventory.observation || "Sin observación",
        },
      ],
      table: {
        columns: [
      ...
      fileName: `Historial_Inventario_${(
        selectedhistoryInventory.productName || "reporte"
  ...
  return (
    <div className="app-content content">
      ...
      <div className="content-wrapper container-fluid p-0">
        ...
        <p>
          Consulte el historial de movimientos de inventario filtrados por rango
          de fechas.
        </p>
        <div className="mb-1">
          ...
          <div style={{ position: "relative", marginBottom: "1rem" }}>
            ...
            >
              <Button
                ...
                disabled={
                  !selectedhistoryInventory || productDetails.length === 0
                }
                style={{
                  width: "33px",
                  height: "33px",
